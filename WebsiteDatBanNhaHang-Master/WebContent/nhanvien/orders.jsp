	...
	<aside id="ms-side-nav"
		...
		<ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
			...
			<li class="menu-item"><a href="#" class="has-chevron"
				...
				<ul id="product" class="collapse" aria-labelledby="product"
					data-parent="#side-nav-accordion">
					<li><a href="product/productlist.html">Danh Sách Món Ăn</a></li>
					<li><a href="product/addproduct.html">Thêm Món Ăn</a></li>
					<li><a href="product/productdetail.html">Chi Tiêt Món Ăn</a></li>
			...
			<li class="menu-item"><a href="#" class="has-chevron"
				...
				<ul id="invoice" class="collapse" aria-labelledby="invoice"
					data-parent="#side-nav-accordion">
					<li><a href="invoice/invoicelist.html">Danh Sách Hóa Đơn</a>
				</ul></li>
			<!-- Invoice end -->
			...
			<li class="menu-item"><a href="#" class="has-chevron"
				...
				<ul id="pages" class="collapse" aria-labelledby="pages"
					...
					<li class="menu-item"><a href="ban/danhsachban.html"> Danh
							Sách Bàn </a>
					<li class="menu-item"><a href="ban/themban.html"> Thêm Bàn
							Mới </a></li>
		...
		<li class="menu-item"><a href="#" class="has-chevron collapsed"
			...
			<ul id="customer" class="collapse" aria-labelledby="customer"
				...
				<li><a href="customer/danhsachkhachhang.html">Danh Sách
						Khách Hàng</a></li>
				<li><a href="customer/themkhachhang.html">Thêm Khách Hàng</a></li>
										...
										<div class="ms-panel-body">
											<form class="needs-validation clearfix" novalidate>
												<div class="form-row">
													<div class="col-md-12 mb-3">
														...
														<div class="input-group">
															<input type="text" class="form-control"
																...
																required>
															<div class="valid-feedback">Nhập tên bàn ăn</div>
														</div>
													</div>
													...
													<div class="col-md-12 mb-3">
														<textarea id="w3review" placeholder="Ghi Chú"
