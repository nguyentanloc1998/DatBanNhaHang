  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="${pageContext.request.contextPath}/Dashboar"><img src="${pageContext.request.contextPath}/nhanvien/assets/img/costic/costic-logo-84x41.png" alt="logo"> </a>
      </div>
        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Thêm Bàn Mới</li>
            </ol>
          </nav>
        ...
        <div class="col-xl-12 col-md-12">
          <div class="ms-panel ms-panel-fh">
            <div class="ms-panel-header">
              <h6>Thêm Bàn Ăn Mới</h6>
            </div>
            <div class="ms-panel-body">
              <form class="needs-validation clearfix" novalidate action="${pageContext.request.contextPath}/ThemBan" method="post">
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom18">Tên Bàn Ăn</label>
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom18" name="tenban" placeholder="Tên Bàn" value="" required>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <select class="form-control" name="khuvuc" id="validationCustom22" required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="songuoi"  id="validationCustom24" placeholder="0" required>
                      <div class="invalid-feedback">
                        Nhập số lượng người
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                    <select name="trangthai" class="form-control" id="validationCustom25" required>
