				...
				<div class="col-md-12">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb pl-0">
							...
							<li class="breadcrumb-item"><a href="#">Danh Sách Hóa
									Đơn</a></li>
						</ol>
					</nav>
					<div class="col-12">
											...
											<div class="col-sm-12 col-md-6">
												<div id="data-table-5_filter" class="dataTables_filter">
													<label><input type="search" id="myInput"
														...
														placeholder="Tìm Kiếm..." aria-controls="data-table-5"></label>
												</div>
											</div>
										</div>
										<table class="table table-hover thead-primary">
											...
											<tbody id="myTable">
												<c:forEach var="hd" items="${dsHoaDon}">
													<c:if test="${hd.getTrangThai()=='Đang Ăn'}">
														<tr>
								...
								<div class="row align-items-center">
									...
									<div class="col-md-6 text-md-right">
										<ul class="invoice-date">
											<li>Ngày Lập Hóa Đơn : ${hd.getNgayLap()}</li>
								...
								<div class="new">
									...
									<form action="${pageContext.request.contextPath}/HoaDon"
										...
										<button type="submit" name="action" value="In HD"
											class="btn btn-primary">In Hóa Đơn</button>
									</form>
								</div>
