          ...
          <div class="ms-panel ms-panel-fh">
            ...
            <div class="ms-panel-body">
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom18" name="taikhoan" placeholder="Tên Tài Khoản" value="" required>
			 ...
			 <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <input type="password" class="form-control" id="validationCustom18" name="pass" placeholder="Mật Khẩu" value="" required>
                      <div class="valid-feedback">
                       Nhập Mật Khẩu
                      </div>
                    </div>
                   ...
                   <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom18" name="hoten" placeholder="Tên Khách Hàng" value="" required>
                      <div class="valid-feedback">
                       Nhập tên khách hàng
                      </div>
                    </div>
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom18" name="sdt" placeholder="Số Điện Thoại" value="" required>
                      <div class="valid-feedback">
                       Nhập số điện thoại
                      </div>
                    </div>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom18" name="diachi" placeholder="Địa Chỉ" value="" required>
                      <div class="valid-feedback">
                       Nhập địa chỉ
                      </div>
                    </div>
