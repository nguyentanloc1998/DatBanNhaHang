  ...
  <main class="body-content">
    ...
    <div class="ms-content-wrapper">
      <div class="row">
		...
		<form action="${pageContext.request.contextPath}/ThemMonAn"  method="post"  enctype='multipart/form-data'>
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name = "tenmonan" id="tenmonan" placeholder="Tên Món Ăn" value="" required>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <c:forEach var="loaiMon" items="${dsLoaiMonAn}">
                        <option value="${loaiMon.getMaLoaiMonAn()}">${loaiMon.getTenLoaiMonAn() }</option>
                   	</c:forEach>
                      </select>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" name="donvitinh" class="form-control" id="validationCustom24" placeholder="Dĩa" required>
                      <div class="invalid-feedback">
                        Nhập đơn vị tính
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom25" name="gia" placeholder="100.000" required>
                      <div class="invalid-feedback">
                        Giá không đúng
                      </div>
                    </div>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom18" placeholder="Đang Bán"name="trangthai" value="Đang Bán" required="">
                      <div class="valid-feedback">
