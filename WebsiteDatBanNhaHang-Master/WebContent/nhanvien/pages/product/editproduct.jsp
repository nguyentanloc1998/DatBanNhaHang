  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="${pageContext.request.contextPath}../../index.html"><img src="${pageContext.request.contextPath}/nhanvien/assets/img/costic/costic-logo-84x41.png" alt="logo"> </a>
      </div>
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
            ...
            <li class="ms-scrollable ms-dropdown-list">
              ...
              <a class="media p-2" href="#">
                <div class="ms-chat-status ms-status-online ms-chat-img mr-2 align-self-center">
                  <img src="${pageContext.request.contextPath}/nhanvien/assets/img/costic/customer-2.jpg" class="ms-img-round" alt="people">
                </div>
                <div class="media-body">
              ...
              <a class="media p-2" href="#">
                <div class="ms-chat-status ms-status-offline ms-chat-img mr-2 align-self-center">
                  <img src="${pageContext.request.contextPath}/nhanvien/assets/img/costic/customer-3.jpg" class="ms-img-round" alt="people">
                </div>
                <div class="media-body">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="ms-user-img ms-img-round float-right" src="${pageContext.request.contextPath}/nhanvien/assets/img/costic/customer-6.jpg" alt="people"> </a>
        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              <li class="breadcrumb-item"><a href="#"><i class="material-icons">home</i> Trang Chủ</a></li>
...
<form action="${pageContext.request.contextPath}/SuaMonAn"  method="post"  enctype="multipart/form-data"  >
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name = "tenmonan" id="tenmonan" placeholder="Tên Món Ăn" value="${monan.getTenMonAn() }" required>
                  ...
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom22">Loại Món Ăn</label>
                    <div class="input-group">
                      <select name="loaiMon" class="form-control" id="validationCustom22" required>
                      <c:forEach var="loaiMon" items="${dsLoaiMonAn}">
                        <option value="${loaiMon.getMaLoaiMonAn()}" <c:if test="${loaiMon.getMaLoaiMonAn() == monan.getLoaiMonAn().getMaLoaiMonAn()}"> <c:out value= "selected='selected'"/></c:if>>${loaiMon.getTenLoaiMonAn() }</option>
                   	</c:forEach>
                      </select>
                  ...
                  <div class="col-md-6 mb-3">
                    <label for="validationCustom24">Đơn Vị Tính</label>
                    <div class="input-group">
                      <input type="text" name="donvitinh" class="form-control" id="validationCustom24" value="${monan.getDonViTinh() }" placeholder="Dĩa" required>
                      <div class="invalid-feedback">
                        Nhập đơn vị tính
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom25" name="gia" value="${monan.getDonGia() }" placeholder="100.000" required>
                      <div class="invalid-feedback">
                        Giá không đúng
                      </div>
                    </div>
                  ...
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom18">Trạng Thái</label>
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom18" placeholder="Đang Bán"name="trangthai" value="${monan.getTrangThai() }" required="">
                      <div class="valid-feedback">
                  ...
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom12">Ảnh Món Ăn</label>
                    <div class="custom-file">
                      <input type="file"  name="hinhanhmonan" enctype='multipart/form-data'>
                      
                      <div class="invalid-feedback">Tải ảnh không thành công</div>
                    </div>
                  </div>
                  
                </div>
                <div class="new">
                <input type="hidden" value="${monan.getMaMonAn() }" name="idmonan">
                  <button class="btn btn-secondary d-block" type="submit">Đồng ý</button>       
                </div>
