...
<body
	...
	<main class="body-content">
		...
		<div class="ms-content-wrapper">
			<div class="row">
				<div class="col-md-12">
					<h1 class="db-header-title">Xin Chào, Chúc Bạn Ngày Mới Tốt
						Lành</h1>
				</div>
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div
						...
						<div class="ms-card-body media">
							<div class="media-body">
								<span class="black-text"><strong> Tổng Tài Khoản
								</strong></span>
								<h2>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div
						...
						<div class="ms-card-body media">
							<div class="media-body">
								<span class="black-text"><strong>Số Phiếu Đặt
										Bàn</strong></span>
								<h2>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div
						...
						<div class="ms-card-body media">
							<div class="media-body">
								<span class="black-text"><strong>Doanh Thu Hôm
										Nay</strong></span>
								<h2>
									<c:out value="${doanhthuhomnay} VNĐ"></c:out>
								</h2>
							</div>
						</div>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div
						...
						<div class="ms-card-body media">
							<div class="media-body">
								<span class="black-text"><strong>Tổng Doanh Thu
										<br>
								</strong></span>
								<h2>
									<c:out value="${tongtien } VNĐ"></c:out>
								</h2>
							</div>
						</div>
						...
						<div class="ms-panel-header">
							<div class="d-flex justify-content-between">
								<div class="align-self-center align-left">
									<h6>Món ăn được chọn nhiều nhất</h6>
								</div>
					...
					<div class="ms-panel ms-panel-fh">
						<div class="ms-panel-header new">
							...
							<select class="form-control new" id="exampleSelect">
								...
								<option value="4">Tháng Bốn</option>
								<option value="5">Tháng Năm</option>
								<option value="1">Tháng Sáu</option>
								<option value="2">Tháng Bảy</option>
								<option value="3">Tháng Tám</option>
								<option value="4">Tháng Chín</option>
								<option value="5">Tháng Mười</option>
								<option value="4">Tháng Mười Một</option>
								<option value="5">Tháng Mười Hai</option>
							</select>
						</div>
						<div class="ms-panel-body">
							<span class="progress-label"> <strong>Tuần 1</strong>
							</span>
							<div class="progress">
							...
							<span class="progress-label"> <strong>Tuần 2</strong>
							</span>
							<div class="progress">
								<div class="progress-bar bg-primary" role="progressbar"
							...
							<span class="progress-label"> <strong>Tuần 3</strong>
							</span>
							<div class="progress">
								<div class="progress-bar bg-primary" role="progressbar"
							...
							<span class="progress-label"> <strong>Tuần 4</strong>
							</span>
							<div class="progress">
								<div class="progress-bar bg-primary" role="progressbar"
								...
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
									<div class="ms-card no-margin">
										...
										<div class="ms-card-body">
											...
											<div class="ms-card-heading-title">
												<p>
													Số lượng đã đặt <span class="red-text">15</span>
												</p>
												<p>
						...
						<div class="ms-panel-body pt-0">
							<div class="d-flex justify-content-between ms-graph-meta">
								<ul class="ms-list-flex mt-3 mb-5">
									<li><span>Tổng Khách Hàng Đã Đặt Bàn</span>
										<h3 class="ms-count">703,49</h3></li>
									<li><span>Khách Hàng Mới Đặt Bàn</span>
										<h3 class="ms-count">95,038</h3></li>
									<li><span>Khách Hàng Cũ Đặt Bàn</span>
